      ...
      {productValues && (
        <form onSubmit={handleSubmit} className='p-10'>
          <div className='container'>
            ...
            <p className='text-gray-900 italic text-xs'>
              {' '}
              E.g Strawberry Cake / Dogwalking 1 hour
            </p>
            <input
              type='text'
              required
          ...
          <div className='container'>
            ...
            <p className='text-gray-900 italic text-xs'>
              {' '}
              Describe your product/service in details
            </p>
            <ReactQuill
          ...
          {productValues.mainImage ? (
            <span className='relative inline-block'>
              <div className='w-24 h-24'>
                <Avatar
                  key={productValues.mainImage}
                  src={productValues.mainImage}
                  size={6}
                  shape='square'
                  className='w-5'
                />
              ...
              <span
                onClick={() => handleMainImageRemove(productValues.mainImage)}
                class='absolute top-0 right-0 px-2 py-1 text-xs font-bold leading-none text-red-100 transform bg-red-600 rounded-full cursor-pointer'
              >
                x
              </span>
            </span>
          ...
          <div className=''>
            <h5 className='font-bold py-4 text-black'>
          ...
          <div className='container'>
            ...
            <span className='text-gray-900'>
              Describe your main product image. This is useful for SEO
            </span>
            <p className='text-gray-900 italic text-xs'>
              {' '}
              E.g Picture of a freshly baked strawberry cake
            </p>
            <input
              type='text'
              name='mainImageAlt'
          ...
          {images ? (
            images.map((image) => (
              <span key={image} className='relative inline-block'>
                ...
                <span
                  ...
                  className='absolute top-0 right-0 px-2 py-1 text-xs font-bold leading-none text-red-100 transform bg-red-600 rounded-full cursor-pointer'
                >
                  x
                </span>
              </span>
          ...
          <div className='pb-10'>
            <h5 className='font-bold py-4 text-black'>
              Upload Other Product Images (Optional)
            </h5>
            {loading ? (
              <span>Uploading</span>
            ) : (
              <label className='ml-5 p-6  bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'>
                Upload Images
                <input
                  type='file'
                  name='image'
