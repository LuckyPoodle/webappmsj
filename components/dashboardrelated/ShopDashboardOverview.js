...
const ShopDashboardOverview=({shopData})=> {
  ...
  useEffect(()=>{
    ...
    console.log("in shopdashboard");
    console.log(shopData)//shopData[0].owner.ownSho
  },[])

  return (
    <div className="bg-white shadow overflow-hidden sm:rounded-lg">
     {
       shopData[0].owner.ownShop?<> <div className="px-4 py-5 sm:px-6">
     ...
     <div className="border-t border-gray-200">
      ...
      <>
      <div>
      <h1 className='font-bold py-8 text-2xl '>Set up your shop now</h1>
