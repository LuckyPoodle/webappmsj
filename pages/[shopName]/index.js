...
const ShopFront = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Heirloom Shop</h1>
      <img alt="gallery" class="mx-auto w-20 h-20 object-cover object-center" src="https://dummyimage.com/600x360" />
