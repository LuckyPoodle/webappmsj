      ...
      <section class='text-gray-600 body-font'>
        <div class='container px-5 py-24 mx-auto'>
          <div class='flex  flex-col items-center text-center w-full mb-20'>
            ...
            <p class='lg:w-2/3 mx-auto  font-bold  leading-relaxed text-base'>
              {shop.description}
            </p>

            <p class='lg:w-2/3 mx-auto pt-1 leading-relaxed text-base'>
              {shop.address}
            </p>
            <p class='lg:w-2/3 mx-auto pt-1 leading-relaxed text-base'>
              Delivery Info: {shop.deliveryPickUpInfo}
            </p>
            <p class='lg:w-2/3 mx-auto pt-1 leading-relaxed text-base'>
              Delivery Fee: S${shop.deliveryFee}
            </p>
            ...
            <a className='lg:w-2/3 mx-auto pt-1 leading-relaxed text-base'>
              {shop.siteLinkOne}
            </a>
            <a className='lg:w-2/3 mx-auto pt-1 leading-relaxed text-base'>
              {shop.siteLinkTwo}
...
export async function getServerSideProps({ query, req, res }) {
  ...
  const productsData = await axios.get(
    `${process.env.api}/get-shop-products/${query.shopSlug}`
  )
  return {
    props: {
      shop: data,
