...
export default function Home({ products }) {
    ...
    if (navigator.geolocation) {
      if (!navigator.geolocation) {
        ...
        navigator.geolocation.getCurrentPosition(
          (position) => {
            router.push(
              `/search?item=${''}&longitude=${
                position.coords.longitude
              }&latitude=${position.coords.latitude}&address=${
  ...
  const handleViewMoreClick = (category) => {
    if (category === 'Everything') {
      router.push(
        `/search?item=${''}&longitude=${''}&latitude=${''}&address=${''}`
      )
    } else {
      router.push(
        `/search?item=${category}&longitude=${''}&latitude=${''}&address=${''}`
      )
    }
  }
      ...
      <main className='max-w-7xl mx-auto px-8 sm:px-16'>
        <section className='pt-10'>
          ...
          <div className='flex flex-row w-full'>
            <ArrowCircleLeftIcon
              className='hidden sm:block h-10 w-10 text-black'
              onClick={slideLeft}
            />
            <div
              id='slider'
            ...
            >
              <div className='flex flex-nowrap md:ml-10 ml-5 '>
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      onClick={() => {
                        handleCategoryClick('Everything')
                      }}
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Everything' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0  content-center'>
                        <img
                          alt='logo'
                          src='/yellowshootingstar.png'
                          className='h-full w-full hover:border-b-8 rounded-full overflow-hidden shadow'
                        />
                      </div>
                      <p className='text-center text-xs pt-1 mb-2 text-black'>
                        Everything
                      </p>
                    </div>
                  </div>
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Services' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0 content-center'>
                        <img
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Food' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0 content-center'>
                        <img
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Drink' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0  content-center'>
                        <img
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Pet Food' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0  content-center'>
                        <img
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Pet Services' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0  content-center'>
                        <img
                          alt='pet service'
                          src='/petservice-2.png'
                          className='h-full w-full hover:border-b-8 rounded-full overflow-hidden shadow'
                        />
                      </div>
                      <p className='text-center text-xs pt-1 mb-2 text-black'>
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Pet Accessories'
                          ? 'border-b-8'
                          : ''
                      } `}
                    >
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Crafts' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0 content-center'>
                        <img
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Tutoring' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0  content-center'>
                        <img
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Gardening' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0  content-center'>
                        <img
                ...
                <div className='inline-block px-3 '>
                  <div className='w-30 h-30 overflow-hidden rounded-lg  '>
                    <div
                      ...
                      className={`w-full h-full flex flex-col justify-center  ${
                        selectedCategory === 'Beauty' ? 'border-b-8' : ''
                      } `}
                    >
                      <div className='h-20 w-20 mb-4 lg:mb-0  content-center'>
                        <img
          ...
          {obtainedProducts.length > 0 ? (
            <div className='pt-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
              ...
              {obtainedProducts.length >= 7 ? (
                <div className='p-20'>
                  <span
                    onClick={() => handleViewMoreClick(selectedCategory)}
                    className='italic font-bold text-black cursor-pointer'
                  >
                    ...View More
                  </span>
                </div>
            ...
            <div className='h-400 w-400'>
              <span className='font-bold text-lg text-black p-10'>
